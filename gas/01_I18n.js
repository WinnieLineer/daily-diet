...
const I18N_DICT = {
  ...
  summaryTotalCal: { zh: "🔥 熱量", en: "🔥 Calories" },
  summaryTotalPro: { zh: "🥩 蛋白質", en: "🥩 Protein" },
  summaryTotalWater: { zh: "💧 水分", en: "💧 Water" },
  summaryHistCal: { zh: "🔥 熱量", en: "🔥 Calories" },
  summaryHistPro: { zh: "🥩 蛋白質", en: "🥩 Protein" },
  summaryHistWater: { zh: "💧 水分", en: "💧 Water" },

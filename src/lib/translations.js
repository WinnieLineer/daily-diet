const translations = {
  zh: {
    ...
    whatsnew_v320_log_filter_title: "📊 後台全量日誌動態篩選",
    whatsnew_v320_log_filter_desc: "日誌監控儀表板支援動態掃描所有自訂操作類型，點擊類型徽章一鍵瞬時過濾，排查維護更輕鬆！",
  ...
  en: {
    ...
    whatsnew_v320_log_filter_title: "📊 Dynamic Operation Log Filtering",
    whatsnew_v320_log_filter_desc: "Log Monitor Dashboard now dynamically scans and filters all action types. 1-click badge filtering for effortless diagnostics!",

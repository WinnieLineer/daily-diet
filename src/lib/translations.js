const translations = {
  zh: {
    ...
    whatsnew_v210_ai_desc: "全面升級至最新世代的視覺大模型，辨識更穩定、更精準，並將預設倒數時間調整為更符合實際的 10 秒。",
  ...
  en: {
    ...
    whatsnew_v210_ai_desc: "Upgraded to a next-gen vision model for stable, precise recognition. Countdown adjusted to a realistic 10 seconds.",

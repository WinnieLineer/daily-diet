const translations = {
  zh: {
    ...
    whatsnew_v330_sleep_title: "🌙 熊貓教練的睡前悄悄話 🐼",
    whatsnew_v330_sleep_desc: "看完了新功能，今晚就早點放下手機、準備進入夢鄉吧！想要減脂成功，除了吃對、動夠，『高質量的深層睡眠』更是身體天然燃脂的黃金時刻 ✨ 睡前如果思緒還很滿，教練很推薦花 3 分鐘跟著這個短影音做做舒緩放鬆。好好深呼吸，祝大家美夢、減脂順利～晚安！💤🌙",
    whatsnew_v330_sleep_btn: "🧘‍♀️ 點我看 3 分鐘睡前舒緩放鬆 Reel 🌸",
  ...
  en: {
    ...
    whatsnew_v330_sleep_title: "🌙 Coach Panda's Bedtime Note 🐼",
    whatsnew_v330_sleep_desc: "After exploring the new features, put down your phone early tonight! High-quality deep sleep is your body's natural fat-burning secret weapon ✨ Take 3 minutes to unwind with this relaxing bedtime stretch. Deep breaths, sweet dreams, and happy fat loss! 💤🌙",
    whatsnew_v330_sleep_btn: "🧘‍♀️ Watch 3-min Bedtime Relaxation Reel 🌸",

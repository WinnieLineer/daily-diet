const translations = {
  zh: {
    ...
    whatsnew_v260_header: "v2.6.0 LINE 官方帳號連動 & AI 滿血回歸 🐼",
    whatsnew_v260_apology_title: "致用戶的真摯致歉：AI 額度滿血回歸！🙇⚡",
    whatsnew_v260_apology_desc: "非常抱歉讓大家久等了！前陣子因為 AI 額度與開發時間有限，加上全力投入 LINE 官方帳號的架設與串接，導致許多用戶回報「AI 辨識壞掉、卡住或超額」，修復了許久。這次我們特地買了滿滿的 AI 額度！無論是在 Web 還是 LINE 都能極速秒辨識，請大家多多、放心地盡情使用！🐼💖",
    whatsnew_v260_line_title: "LINE 官方帳號正式登場 (@618iipof) 💬",
    whatsnew_v260_line_desc: "現在只要加入 LINE 官方帳號「Daily Diet 熊貓教練」，傳送餐點照片或輸入文字，AI 即可自動計算熱量、蛋白質、碳水與脂肪，資料 100% 雙向秒級同步！",
    whatsnew_v260_water_title: "快捷補水站 & ⭐ 常用餐點滑動庫 💧",
    whatsnew_v260_water_desc: "在 LINE 內可左右滑動卡片一鍵記錄常用餐點，點擊快捷鈕秒補水，更支援秒開極速分包與企業級安全防護！",
    whatsnew_v260_btn_add_line: "👉 點擊一鍵加入 LINE 好友 (@618iipof)",
    ...
    v260_line_title: "LINE 官方帳號登場 (@618iipof) 💬",
    v260_water_title: "快捷補水站 & ⭐ 常用餐點滑動庫 💧",

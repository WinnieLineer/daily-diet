const translations = {
  zh: {
    ...
    data_backup_hint: "⚠️ 提醒：資料皆儲存在手機地端瀏覽器中，並未上傳雲端。若清除瀏覽器資料或更換裝置，紀錄將會遺失，請務必定期導出備份。",
  ...
  en: {
    ...
    data_backup_hint: "⚠️ Note: All data is stored locally in your browser and NOT synced to the cloud. Clearing browser data or switching devices will result in data loss. Please export backups regularly.",

const translations = {
  zh: {
    ...
    data_backup_hint: "⚠️ 提醒：資料預設儲存於手機地端。為避免更換裝置或清除資料導致紀錄遺失，建議您登入並定期上傳至 Google Drive 雲端備份。",
    ...
    logout_google: "登出 Google",
    logged_in_google: "已透過 Google 登入",
    backup_desc: "登入以啟用雲端同步與備份功能 ☁️",
    google_connected: "已連結 Google 帳號",
    google_account: "Google 帳號",
    cloud_backup: "雲端備份",
    cloud_sync: "雲端同步",
    backup_to_drive: "上傳至 Google Drive",
    restore_from_drive: "從 Google Drive 還原",
  ...
  en: {
    ...
    data_backup_hint: "⚠️ Note: Data is stored locally by default. To prevent data loss when switching devices or clearing browser data, we recommend logging in and backing up to Google Drive regularly.",

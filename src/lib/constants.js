...
export const APP_VERSION = '3.3.84';         // 🏷️ Application Version (from package.json)
export const ENABLE_520_THEME = false;      // 💖 520 Festive decorations toggle
export const CURRENT_WHATSNEW_ID = 'whatsnew_v3.3.80'; // 📢 Current update card ID (change to show to all users once)
